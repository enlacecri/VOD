...
def run(burst: bool = False, redis_url: str = None, queue_name: str = None, worker_name: str = None, with_scheduler: bool = False):
...
if __name__ == '__main__':
    ...
    parser.add_argument("--with-scheduler", action="store_true", default=False, help="Run scheduler process on this worker")
    args = parser.parse_args()

    run(burst=args.burst, queue_name=args.queue, worker_name=args.name, with_scheduler=args.with_scheduler)
